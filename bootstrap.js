...
var core = {
	addon: {
		...
		path: {
			name: 'tweeeeeeeeeeeeeeeeeeter',
			//
			content: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/',
			locale: 'chrome://tweeeeeeeeeeeeeeeeeeter/locale/',
			//
			resources: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/resources/',
			images: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/resources/images/',
			scripts: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/resources/scripts/',
			styles: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/resources/styles/',
			fonts: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/resources/styles/fonts/',
			pages: 'chrome://tweeeeeeeeeeeeeeeeeeter/content/resources/pages/'
...
function startup(aData, aReason) {
	xpcomSetTimeout(null, 1000, function() {
